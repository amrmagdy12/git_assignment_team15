...
public class Fibonnacci implements ISubscriber {
	@Override
	public void notifySubscriber(int n) {
		...
		if (n == 1 || n == 2) System.out.println("(Fibonnacci observer): Result is: " + 1);
		else {
			...
			System.out.println("(Fibonnacci observer): Result is: " + result);
		}
	}
}
